...
if(isset($_POST['up_teacher']))
{
    ...
    $up_adhar = $_POST['up_adhar'];
	
	$update_done = $ravi->update_teacher_info($up_fullname,$up_address,$up_email,$up_father,$up_mother,$up_dob,$up_qualification,$up_contact,$up_staff,$up_gender,$teacher_id,$up_adhar);
	if($update_done==true)
	{
			...
			<div class="form-body">
				<form class="form-horizontal" method="post">
                    ...
                    <div class="form-group"> <label for="address" class="col-sm-2 control-label">Staff Adhar</label>
						<div class="col-sm-9"> <input type="text" class="form-control" name="up_adhar" value="<?php echo $edit_teacher_display['t_adhar']; ?>"> </div>
