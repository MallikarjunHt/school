<?php 
 ...
 if(isset($_POST['add_teacher_info']))
 {
     ...
     $add_t_adhar = $_POST['add_t_adhar'];
	 if($add_t_fullname=="" OR $add_t_address=="" OR $add_t_email=="" OR $add_t_username=="" OR $add_t_pass=="" OR $add_t_father=="" OR $add_t_mother=="" OR $add_t_dob=="" OR $add_t_qualification=="" OR $add_t_contact=="" OR $add_t_staff=="" OR $add_t_gender=="" OR $add_t_adhar=="")
	 {
	 ...
	 $add_done = $ravi->add_teacher($add_t_fullname,$add_t_address,$add_t_email,$add_t_username,$add_t_pass,$add_t_father,$add_t_mother,$add_t_dob,$add_t_qualification,$add_t_contact,$add_t_staff,$add_t_gender,$add_t_adhar);
	 if($add_done==true)
	 {
		...
		<div class="grid-1">
			<div class="form-body">
				...
				<div class="form-group"> <label for="address" class="col-sm-2 control-label">Username</label>
                    ...
                    <div class="form-group"> <label for="address" class="col-sm-2 control-label">Staff Adhar</label>
						<div class="col-sm-9"> 
                            <input type="number" pattern="[0-9]{8}" length="12" class="form-control" name="add_t_adhar" placeholder="************"> </div>
