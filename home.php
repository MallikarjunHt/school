...
<body>
	<div class="page-container">
		...
		<div class="sidebar-menu">
			<header class="logo">
				<a href="#" class="sidebar-icon"> <span class="fa fa-bars"></span> </a> <a href="index.html"> <span id="logo"> <h1>Administrator</h1></span> 
			...
			<!--/down-->
			<div class="down">
				<a href="index.html"><img src="../images/download.png"></a>
				...
				<ul id="menu">
					...
					<li id="menu-academico"><a href="#"><i class="fa fa-table"></i> <span>Students</span> <span class="fa fa-angle-right" style="float: right"></span></a>
						<ul id="menu-academico-sub">
							...
							<li id="menu-academico-avaliacoes"><a href="home.php?ravi=st-delete">Delete Students</a></li>
